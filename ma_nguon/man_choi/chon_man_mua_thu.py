...
class AutumnLevelsScene:
    def __init__(self, game):
        self.game = game
        self.font = pygame.font.Font("tai_nguyen/font/Fz-Donsky.ttf", 50)
        self.selected = 0
        self.options = ["Màn 1 - Rừng Vàng Nhẹ Nhàng", "Màn 2 - Gió Thu Dâng Trào", "Màn 3 - Bão Lá Cuồng Nộ", "Quay lại"]
        self.level_scenes = ["map_mua_thu_man1", "map_mua_thu_man2", "map_mua_thu_man3", "menu"]
    ...
    def draw(self, screen):
        ...
        title_surface = self.font.render("CHỌN MÀN MÙA THU", True, title_color)
        ...
        # Create shadow
        title_shadow_surface = self.font.render("CHỌN MÀN MÙA THU", True, shadow_color)
