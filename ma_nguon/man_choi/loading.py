...
class LoadingScene:
    ...
    def load_next_scene(self):
        ...
        elif self.target_scene == "map_rung_linh_vuc":
...
#mapninja
        elif self.target_scene == "map_ninja":
            from ma_nguon.man_choi.map_ninja import MapNinjaScene
            self.game.current_scene = MapNinjaScene(self.game, player=self.game.selected_player)
