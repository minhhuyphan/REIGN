...
class MapMuaThuMan2Scene:
    def __init__(self, game, player=None):
        ...
        if player:
            ...
            print(f"[MapMuaThuMan2] Received player with stats: HP={self.player.hp}, DMG={self.player.damage}, SPD={self.player.speed}")
        else:
            # Code tạo player mới
            ...
            print(f"[MapMuaThuMan2] Created new player with default stats")
        ...
        for group in range(4):
            ...
            for i in range(num_enemies):
                ...
                enemy = QuaiVat(x_pos, 300, folder_qv, sound_qv, color=(255, 140, 0), damage=12)  # Damage trung bình
                # Thiết lập vùng hoạt động trung bình
                enemy.speed = 2.5
                enemy.home_x = x_pos
                enemy.patrol_range = 200
                enemy.aggro_range = 300
                enemy.hp = int(enemy.hp * 1.0)  # Máu bình thường
        ...
        # Boss mạnh hơn màn 1 nhưng chưa quá khó
        for boss in self.bosses:
            boss.hp = int(boss.hp * 1.0)  # Máu bình thường
            boss.damage = int(boss.damage * 1.0)  # Sát thương bình thường
            boss.speed = boss.speed * 1.0  # Tốc độ bình thường
